        ...
        <div className='' style={{ paddingBottom: '0' }}>
          ...
          {activeFilter.length > 0 && (
            <div className="row d-flex align-items-center" style={{ padding: '8px 0px 5px 0px' }}>
              <div className="col col-md-2 col-sm-6"> Active Filters :</div>
              <div className="col col-md-8 col-sm-6 d-flex align-items-center">
                {activeFilter.map(i => (
                  <div className="thumbnailList ml-2" style={{ paddingBottom: '0px' }}>
                    <span data-src="8" className="badge" style={{ border: '1px solid #777', borderRadius: '15px' }}>
          ...
          {showFilterOptions === true && (
            <div className='tab-content' style={{ border: '1px solid #ddd', borderRadius: '.5rem' }}>
              <div className='tab-pane active filterOpenTab p-3' >
                <div className="row">
                  {filtersList}
                  <div className="col-lg-3 col-md-3 col-sm-6 col-xs-6 auto-clear-lg-3 ">
                    {!applyFilterOnSelect && (
